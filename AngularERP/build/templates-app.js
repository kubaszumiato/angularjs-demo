angular.module('templates-app', ['about/about.tpl.html', 'articles/articleDetails.tpl.html', 'articles/articles.tpl.html', 'home/home.tpl.html', 'orders/orderDetails.tpl.html', 'orders/orders.tpl.html']);
...
angular.module("about/about.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("about/about.tpl.html",
    ...
    "\n" +
    "  <p>\n" +
    "    Because my team and I make web apps, and sdfsfsdfsfssfsdf\n" +
    "      dfsdfsdfs\n" +
...
angular.module("articles/articleDetails.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("articles/articleDetails.tpl.html",
    "\n" +
    "<div ng-app=\"ngBoilerplate.articles\" ng-controller=\"ArticleDetailsCtrl\">\n" +
    "\n" +
    "    <h1 class=\"page-header\">\n" +
    "        Article Details\n" +
    "        <!--<small>For the lazy and impatient.</small>-->\n" +
    ...
    "            <button type=\"button\" class=\"btn btn-primary\" ng-click=\"openList()\"> go back to the list</button>\n" +
    "  \n" +
    "        </div>\n" +
    "\n" +
    "        <div title=\"Article Details\">\n" +
    "            <div>\n" +
    ...
    "                </table>\n" +
    "            </div>\n" +
    "            <h3>Id <span class=\"label label-default\">{{article.id}}</span></h3>\n" +
    "            <h3>Code <span class=\"label label-default\">{{article.company}}</span></h3>\n" +
    "            <h3>Producer <span class=\"label label-default\">{{article.producer}}</span></h3>\n" +
    "            <h3>About <span class=\"label label-default\" word-wrap:break-word>{{article.about}}</span></h3>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "\n" +
    "\n" +
...
angular.module("articles/articles.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("articles/articles.tpl.html",
    "\n" +
    "<div ng-app=\"ngBoilerplate.articles\" ng-controller=\"ArticlesCtrl\">\n" +
    "\n" +
    ...
    "            <button type=\"button\" class=\"btn btn-primary\" ng-click=\"refreshArticles()\">\n" +
    ...
    "\n" +
    "            <!--<tbody>\n" +
    "                <tr ng-repeat=\"article in articles\" ng-click=\"articlesDetail(article.id)\" infinite-scroll='loadMore()' infinite-scroll-distance='2'>\n" +
    "                    <td>{{article.id}}</td>\n" +
    "                    <td>{{article.code}}</td>-->\n" +
    "            <!--<td> <img src=\"{{article.picture}}\" class=\"p\" /></td>-->\n" +
    "\n" +
    "\n" +
    "            <tbody>\n" +
    ...
    "                    <td>{{article.code}}</td>\n" +
    "\n" +
    "                    <td><a class=\"btn btn-primary\" ng-click=\"getArticleDetails(article)\"> details</a>  </td>\n" +
    "\n" +
    "\n" +
    "                </tr>\n" +
    "            </tbody>\n" +
...
angular.module("orders/orderDetails.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("orders/orderDetails.tpl.html",
    "<div class=\"jumbotron\">\n" +
    "    {{id}}\n" +
    "    <div class=\"col-sm-3 col-md-2 sidebar\">\n" +
    "        <ul class=\"nav nav-sidebar\">\n" +
    "            <li ng-repeat=\"orderHeader in orders\" class=\"active\">\n" +
    "                <a href=\"\">{{orderHeader.numerator}}</a>\n" +
    "            </li>\n" +
    "        </ul>\n" +
    "    </div>\n" +
    "    <div class=\"col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main\">\n" +
    "        <h1 class=\"page-header\">{{order.numerator}}</h1>\n" +
    "\n" +
    "        <div class=\"col-md-6\">\n" +
    "            {{order.customer}}\n" +
    "        </div>\n" +
    ...
    "        <div class=\"row\">\n" +
    "            <div class=\"col-md-4\">\n" +
    "                <a href=\"\" ng-click=\"predicate = 'code'; reverse=!reverse\">Code</a>\n" +
    "            </div>\n" +
    "            <div class=\"col-md-4\">\n" +
    ...
    "            </div>\n" +
    "            <div class=\"col-md-4\">\n" +
    "                <a href=\"\" ng-click=\"predicate = 'quantity'; reverse=!reverse\">Quantity</a>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "        <div class=\"row\" ng-repeat=\"element in order.items | orderBy:predicate:reverse\">\n" +
    "            <div class=\"col-md-4\">{{element.code}}</div>\n" +
    "            <div class=\"col-md-4\">{{element.name}}</div>\n" +
    "            <div class=\"col-md-4\">{{element.price | curency \"PLN \" : 0}}</div>\n" +
    "            <div class=\"col-md-4\">{{element.quantity}}</div>\n" +
    "        </div>\n" +
    "        <!--<div class=\"row\">\n" +
    "                <div style=\"background-color: green\" class=\"col-md-6 col-md-offset-5\">\n" +
    "                    abc\n" +
    "                </div>\n" +
    "            </div>-->\n" +
    "\n" +
...
angular.module("orders/orders.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("orders/orders.tpl.html",
    ...
    "    <div class=\"row\">\n" +
    "        <div class=\"col-md-2\">\n" +
    "            <a href=\"\" ng-click=\"predicate = 'numerator'; reverse=!reverse\">Numerator</a>\n" +
    "        </div>\n" +
    "        <div class=\"col-md-2\">\n" +
    "            <a href=\"\" ng-click=\"predicate = 'customer'; reverse=!reverse\">Customer</a>\n" +
    "        </div>\n" +
    "        <div class=\"col-md-2\">\n" +
    "            <a href=\"\" ng-click=\"predicate = 'value'; reverse=!reverse\">Value</a>\n" +
    "        </div>\n" +
    "        <div class=\"col-md-6\">Tags</div>\n" +
    "    </div>\n" +
    "\n" +
    "    <div class=\"row\" ng-repeat=\"order in orders | orderBy:predicate:reverse\" ng-click=\"showOrderDetails(order)\">\n" +
    "        <div class=\"col-md-2\">\n" +
    "            <a ng-click=\"showOrderDetails(order)\">{{order.numerator}}</a>\n" +
    "        </div>        \n" +
    "        <div class=\"col-md-2\">{{order.customer}}</div>\n" +
    "        <div class=\"col-md-2\">{{order.value}}</div>\n" +
    "        <div class=\"col-md-6\">\n" +
    "            <a href=\"\" ng-repeat=\"tag in order.tags\">{{\"#\" + tag + \" \" }}</a>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "    <!--<div class=\"row\">\n" +
    "            <div style=\"background-color: green\" class=\"col-md-6 col-md-offset-5\">\n" +
